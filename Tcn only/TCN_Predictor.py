...
if __name__ == '__main__':
    ...
    socketio.run(app, host='0.0.0.0', port=80, debug=False, use_reloader=False, allow_unsafe_werkzeug=True) # Added allow_unsafe_werkzeug for recent Flask/Werkzeug versions if needed